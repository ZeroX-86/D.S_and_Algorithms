...
typedef struct{
    QUEUE_ENTRY entry_arr[MAX_QUEUE_LENGTH];
...
QAB_return_t QAB_queue_append(Queue_ArrBased *ptr_queue,QUEUE_ENTRY *ptr_entry);
QAB_return_t QAB_queue_serve(Queue_ArrBased *ptr_queue,QUEUE_ENTRY *ptr_entry);
QAB_return_t QAB_queue_retrive(Queue_ArrBased *ptr_queue,QUEUE_ENTRY *ptr_entry);
QAB_return_t QAB_queue_clear(Queue_ArrBased *ptr_queue);
QAB_return_t QAB_queue_traverse(Queue_ArrBased *ptr_queue,void(*ptr_func)(QUEUE_ENTRY));
